...
\date{\today}
% Release checklist: (1) fill \pushdate below with the date the repository was
% made public; (2) confirm the code link in \title resolves before submission.
\newcommand{\pushdate}{\textcolor{red}{\textbf{[PUSH DATE --- FILL BEFORE SUBMISSION]}}}
